...
const ReportPage = () => {
    ...
    const totalTxns = analysisData?.total_transactions || 0;
            ...
            <main className="flex-1 px-10 py-10 overflow-auto">
                {!hasData ? (
                    <div className="bg-white p-10 rounded-2xl shadow-sm border border-gray-100 text-center max-w-md mx-auto mt-20">
                        ...
                        <p className="text-gray-500 mb-6">You haven't uploaded any bank statements yet. Please upload to generate your report.</p>
